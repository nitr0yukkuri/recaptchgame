            ...
            {loginStep === 'CPU_PLAYER_COUNT' && (
                <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 py-2 sm:py-3 mt-4 sm:mt-12 md:mt-28">
                    ...
                    <div className="w-full max-w-md space-y-2 sm:space-y-3">
                        ...
                        >
                            <div className="bg-blue-100 text-blue-600 font-black text-lg sm:text-2xl w-9 h-9 sm:w-12 sm:h-12 flex items-center justify-center rounded-full shrink-0">1</div>
                            <div className="text-left">
                        ...
                        >
                            <div className="bg-orange-100 text-orange-600 font-black text-lg sm:text-2xl w-9 h-9 sm:w-12 sm:h-12 flex items-center justify-center rounded-full shrink-0">3</div>
                            <div className="text-left">
