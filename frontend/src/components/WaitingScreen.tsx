...
export const WaitingScreen = ({ roomId, cancelWaiting }: WaitingScreenProps) => {
    return (
        <div className="text-center h-full flex flex-col items-center justify-center space-y-10">
            <div className="animate-spin h-14 w-14 md:h-20 md:w-20 border-4 md:border-8 border-[#5B46F5] border-t-transparent rounded-full"></div>
            <div>
                <p className="text-xl md:text-3xl font-bold text-gray-700">対戦相手を待機中...</p>
                <p className="text-sm md:text-lg text-gray-400 mt-2">Room: {roomId}</p>
            </div>
            <button
